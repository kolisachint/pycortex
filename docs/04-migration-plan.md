...
- [x] **4.3 session** — `packages/coding-agent/src/core/agent-session*.ts`,
...
- [x] **5.2 interactive** — `packages/coding-agent/src/modes/interactive/**` →
...
- [x] **5.6 cli umbrella publishable** — flip T2 leaves `publish=true`, release first
