...
MODELS: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "groq": {
        ...
        "qwen/qwen3-32b": {
            ...
            "baseUrl": "https://api.groq.com/openai/v1",
            "reasoning": True,
            "thinkingLevelMap": {"minimal": None, "low": None, "medium": None, "high": "default"},
            "input": ["text"],
    ...
    "openrouter": {
        ...
        "aion-labs/aion-3.0": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 3, "output": 6, "cacheRead": 0.75, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 32768,
        },
        "aion-labs/aion-3.0-mini": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.7, "output": 1.4, "cacheRead": 0.18, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 32768,
        },
        ...
        "anthropic/claude-sonnet-5": {
            ...
            "reasoning": True,
            "input": ["text", "image"],
            "cost": {"input": 2, "output": 10, "cacheRead": 0.19999999999999998, "cacheWrite": 2.5},
            "contextWindow": 1000000,
            "maxTokens": 128000,
        },
        ...
        "deepseek/deepseek-v3.2": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.2145, "output": 0.32175, "cacheRead": 0.02145, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 64000,
        },
        ...
        "minimax/minimax-m2": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.255, "output": 1.02, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 204800,
            "maxTokens": 131072,
        },
        ...
        "moonshotai/kimi-k2.6": {
            ...
            "reasoning": True,
            "input": ["text", "image"],
            "cost": {"input": 0.66, "output": 3.41, "cacheRead": 0.15, "cacheWrite": 0},
            "contextWindow": 262144,
            "maxTokens": 262144,
        },
        "moonshotai/kimi-k2.7-code": {
            ...
            "reasoning": True,
            "input": ["text", "image"],
            "cost": {"input": 0.72, "output": 3.5, "cacheRead": 0.15, "cacheWrite": 0},
            "contextWindow": 262144,
            "maxTokens": 262144,
        },
        "nex-agi/nex-n2-mini": {
        ...
        "nvidia/nemotron-3-super-120b-a12b": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.08, "output": 0.44999999999999996, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 1000000,
            "maxTokens": 4096,
        },
        ...
        "openai/gpt-5.6-luna": {
            ...
            "reasoning": True,
            "input": ["text", "image"],
            "cost": {"input": 1, "output": 6, "cacheRead": 0.09999999999999999, "cacheWrite": 1.25},
            "contextWindow": 1050000,
            "maxTokens": 128000,
        },
        ...
        "openai/gpt-oss-120b": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.036, "output": 0.18, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 4096,
        },
        ...
        "openai/gpt-oss-20b": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.029, "output": 0.14, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 4096,
        },
        ...
        "poolside/laguna-xs-2.1": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.06, "output": 0.12, "cacheRead": 0.03, "cacheWrite": 0},
            "contextWindow": 262144,
            "maxTokens": 32768,
        },
        ...
        "z-ai/glm-5.1": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.966, "output": 3.036, "cacheRead": 0.1794, "cacheWrite": 0},
            "contextWindow": 202752,
            "maxTokens": 128000,
        },
        "z-ai/glm-5.2": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.42, "output": 1.32, "cacheRead": 0.078, "cacheWrite": 0},
            "contextWindow": 1048576,
            "maxTokens": 131072,
        },
        "z-ai/glm-5v-turbo": {
    ...
    "together": {
        ...
        "MiniMaxAI/MiniMax-M3": {
            ...
            "reasoning": True,
            "thinkingLevelMap": {"minimal": None, "low": None, "medium": None},
            "input": ["text", "image"],
            "cost": {"input": 0.3, "output": 1.2, "cacheRead": 0.06, "cacheWrite": 0},
            "contextWindow": 524288,
            "maxTokens": 250000,
        ...
        "google/gemma-4-31B-it": {
            ...
            "thinkingLevelMap": {"minimal": None, "low": None, "medium": None},
            "input": ["text", "image"],
            "cost": {"input": 0.39, "output": 0.97, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 262144,
            "maxTokens": 131072,
        },
        "meta-llama/Llama-3.3-70B-Instruct-Turbo": {
            ...
            "reasoning": False,
            "input": ["text"],
            "cost": {"input": 1.04, "output": 1.04, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 131072,
        },
        "moonshotai/Kimi-K2.6": {
        ...
        "nvidia/nemotron-3-ultra-550b-a55b": {
            ...
            "thinkingLevelMap": {"minimal": None, "low": None, "medium": None},
            "input": ["text"],
            "cost": {"input": 0.6, "output": 3.6, "cacheRead": 0.2, "cacheWrite": 0},
    ...
    "vercel-ai-gateway": {
        ...
        "kwaipilot/kat-coder-pro-v2.5": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.74, "output": 2.96, "cacheRead": 0.15, "cacheWrite": 0},
            "contextWindow": 256000,
            "maxTokens": 80000,
        },
        ...
        "moonshotai/kimi-k2-thinking": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.47, "output": 2, "cacheRead": 0.14100000000000001, "cacheWrite": 0},
        ...
        "openai/gpt-oss-120b": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.09999999999999999, "output": 0.5, "cacheRead": 0, "cacheWrite": 0},
            "contextWindow": 131072,
            "maxTokens": 131072,
        },
        "openai/gpt-oss-20b": {
        ...
        "zai/glm-4.7": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 0.6, "output": 2.2, "cacheRead": 0.12, "cacheWrite": 0},
            "contextWindow": 200000,
            "maxTokens": 120000,
        },
        "zai/glm-4.7-flash": {
        ...
        "zai/glm-5.1": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 1.3, "output": 4.300000000000001, "cacheRead": 0.26, "cacheWrite": 0},
    ...
    "xiaomi": {
        ...
        "mimo-v2.5-pro-ultraspeed": {
            ...
            "reasoning": True,
            "input": ["text"],
            "cost": {"input": 1.305, "output": 2.61, "cacheRead": 0.0108, "cacheWrite": 0},
            "contextWindow": 1048576,
            "maxTokens": 131072,
        },
    },
