"""Auto-generated image model data.
...
IMAGE_MODELS: dict[str, dict[str, dict[str, Any]]] = {
    "openrouter": {
        ...
        "openai/gpt-5-image": {
            ...
            "input": ["image", "text"],
            "output": ["image", "text"],
            "cost": {"input": 10, "output": 10, "cacheRead": 1.25, "cacheWrite": 0},
        },
        "openai/gpt-5-image-mini": {
            ...
            "input": ["image", "text"],
            "output": ["image", "text"],
            "cost": {"input": 2.5, "output": 2, "cacheRead": 0.25, "cacheWrite": 0},
        },
        "openai/gpt-5.4-image-2": {
            ...
            "input": ["image", "text"],
            "output": ["image", "text"],
            "cost": {"input": 8, "output": 15, "cacheRead": 2, "cacheWrite": 0},
        },
        "openrouter/auto": {
            "id": "openrouter/auto",
            "name": "Auto Router",
